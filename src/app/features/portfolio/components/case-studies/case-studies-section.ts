  ...
  template: `
    <section id="cases" class="py-24 sm:py-32 bg-white dark:bg-slate-950 overflow-hidden">
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <ul class="space-y-32 list-none p-0">
          @for (case of cases(); track case.id; let i = $index) {
            <li
              class="group relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center"
            >
              <!-- Content Side -->
              <div
              ...
              >
                <!-- Header Tags -->
                <ul class="flex items-center gap-3 mb-6 list-none pop-0">
                ...
                <!-- Key Results Grid -->
                <ul
                  class="grid grid-cols-2 gap-6 border-t border-slate-200 dark:border-slate-800 pt-8 mt-auto list-none p-0"
                >
