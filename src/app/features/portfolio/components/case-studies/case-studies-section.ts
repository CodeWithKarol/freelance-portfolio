      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center mb-16 sm:mb-24">
          ...
          <p class="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
             Deep dives into complex challenges solved with modern architecture and engineering best practices.
          </p>
        </div>
        ...
        <div class="space-y-24 sm:space-y-32">
          ...
          <div class="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            ...
            >
              ...
              <!-- Browser window mock -->
              <div class="relative z-10 rounded-xl bg-slate-900 shadow-2xl overflow-hidden ring-1 ring-white/10 group">
                 <!-- Browser Bar -->
                <div class="flex items-center gap-2 px-4 py-3 bg-slate-800/50 border-b border-white/5">
                  ...
                  <div class="mx-auto text-xs font-mono text-slate-400 px-3 py-0.5 rounded-full bg-black/20">
                     {{ parseUrl(case.demoUrl) }}
                  </div>
                </div>

                <!-- Content Area (Image Placeholder) -->
                <div class="aspect-[16/10] bg-slate-800 relative group-hover:opacity-90 transition-opacity">
                    <div class="absolute inset-0 flex items-center justify-center">
                      <div class="text-center p-8">
                         <span class="block text-4xl font-black text-slate-700 dark:text-slate-600 tracking-tighter opacity-50">{{ case.title }}</span>
                      </div>
                    </div>

                    <!-- Hover Actions -->
                    <div class="absolute inset-0 bg-slate-950/60 backdrop-blur-[1px] opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-4">
                       @if (case.demoUrl) {
                        <a 
                          [href]="case.demoUrl" 
                          target="_blank"
            ...
            >
              <div class="flex items-center gap-2 mb-4">
                 <span class="inline-flex items-center rounded-md bg-blue-50 dark:bg-blue-900/30 px-2.5 py-1 text-xs font-semibold text-blue-700 dark:text-blue-300 ring-1 ring-inset ring-blue-700/10">Case Study</span>
                 <span class="text-sm text-slate-500 dark:text-slate-400 font-mono">{{ i + 1 | number:'2.0' }}</span>
              </div>
              
              <h3 class="text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">
                {{ case.title }}
              </h3>
              ...
              <dl class="mt-8 space-y-8 text-base leading-7 text-slate-600 dark:text-slate-400">
                ...
                <div class="relative pl-9">
                  <dt class="inline font-semibold text-slate-900 dark:text-white">
                    <svg class="absolute left-1 top-1 h-5 w-5 text-emerald-600 dark:text-emerald-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" /></svg>
                    The Solution.
                  </dt>
              ...
              <div class="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800">
                <h4 class="text-sm font-semibold text-slate-900 dark:text-white mb-4">Impact & Results</h4>
               ...
               <div class="mt-8 flex flex-wrap gap-2">
                 @for (tech of case.techStack; track tech) {
                    <span class="inline-flex items-center rounded-md bg-slate-100 dark:bg-slate-800 px-2 py-1 text-xs font-medium text-slate-600 dark:text-slate-300 ring-1 ring-inset ring-slate-500/10">
                      {{ tech }}
                    </span>
                 }
               </div>
