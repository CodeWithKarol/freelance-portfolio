      ...
      <div class="relative px-6 pt-24 pb-16 lg:px-8 lg:pt-32 lg:pb-24">
        <div class="mx-auto max-w-2xl text-center">
          ...
          <p class="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
            Case studies focused on modernization, performance wins, and scalable architecture—built
            to reduce risk and deliver measurable outcomes.
          </p>
        </div>
      </div>
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8 pb-32">
        ...
        >
          ...
          >
            ...
            >
              ...
              <span class="text-slate-300 border border-slate-700 px-2 py-0.5 rounded-full">{{
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
              <span
                class="text-sm font-semibold leading-6 text-white group-hover:text-indigo-300 flex items-center gap-2 transition-colors"
              >
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-12 sm:gap-y-16 lg:grid-cols-2">
          ...
          <article class="relative flex flex-col items-start justify-between group h-full">
            <!-- Image Wrapper -->
            <div
              class="relative w-full overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-800 aspect-[16/9] shadow-sm"
            >
              <img
                [src]="
                  project.heroImage ||
              ...
              />
              <div
                class="absolute inset-0 rounded-2xl ring-1 ring-inset ring-slate-900/10 dark:ring-white/10"
              ></div>
            ...
            <div class="max-w-xl w-full flex flex-col flex-grow pt-6">
              ...
              <div class="flex flex-wrap items-center gap-2 text-xs mb-3">
                ...
                <span
                  class="relative z-10 rounded-full bg-slate-50 dark:bg-slate-800/50 px-2.5 py-1 font-medium text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700"
                >
                  {{ tech }}
                </span>
              ...
              <div class="group flex-grow">
                <h3
                  class="mt-2 text-xl font-bold leading-6 text-slate-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors"
                >
              ...
              >
                <span
                  class="text-sm font-semibold text-primary-600 dark:text-primary-400 flex items-center gap-2 group-hover:gap-3 transition-all"
                >
                  View Case Study
                  <svg
                    class="w-4 h-4"
