          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 max-w-6xl mx-auto">
            ...
            <div class="lg:col-span-8 space-y-16">
              ...
              >
                ...
                <h3 class="relative text-lg font-semibold text-white mb-4 flex items-center gap-2">
                ...
                <div class="relative text-slate-300 leading-relaxed">
                  ...
                  } @else { Built with modern Angular architecture leveraging Signals for granular
                  reactivity. The state management strategy ensures type-safe, predictable data flow
                  while maintaining exceptional runtime performance. }
                </div>
              </section>
            </div>
